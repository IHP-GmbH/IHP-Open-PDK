...
proc sg13cmos5l::diode_recalc {field parameters} {
...
proc sg13cmos5l::diode_convert {parameters} {
...
proc sg13cmos5l::diode_dialog {device parameters} {
...
proc sg13cmos5l::compute_aptot {parameters} {
    foreach key [dict keys $parameters] {
        set $key [dict get $parameters $key]
    }
...
proc sg13cmos5l::diode_check {parameters} {
...
proc sg13cmos5l::dantenna_defaults {} {
    return {w 0.78 l 0.78 area 0.6084 peri 1.8 \
...
proc sg13cmos5l::dantenna_convert {parameters} {
    return [sg13cmos5l::diode_convert $parameters]
}

proc sg13cmos5l::dpantenna_convert {parameters} {
    return [sg13cmos5l::diode_convert $parameters]
}

#----------------------------------------------------------------

proc sg13cmos5l::dantenna_dialog {parameters} {
    sg13cmos5l::diode_dialog dantenna $parameters
}

proc sg13cmos5l::dpantenna_dialog {parameters} {
    sg13cmos5l::diode_dialog dpantenna $parameters
}

#----------------------------------------------------------------

proc sg13cmos5l::dantenna_check {parameters} {
    sg13cmos5l::diode_check $parameters
}

proc sg13cmos5l::dpantenna_check {parameters} {
    sg13cmos5l::diode_check $parameters
}
...
proc sg13cmos5l::diode_device {parameters} {
    ...
    set cext [sg13cmos5l::guard_ring $gx $gy $guardparams]
    ...
    set cext [sg13cmos5l::unionbox $cext [sg13cmos5l::draw_contact ${w} ${l} \
...
proc sg13cmos5l::diode_draw {parameters} {
    tech unlock *
    ...
    tech lock *
    set bbox [sg13cmos5l::diode_device $parameters]
	...
	for {set yp 0} {$yp < $ny} {incr yp} {
	    ...
	    sg13cmos5l::diode_device $parameters
            box move n ${dy}um
        }
	popbox
        box move e ${dx}um
...
proc sg13cmos5l::dantenna_draw {parameters} {
...
proc sg13cmos5l::dpantenna_draw {parameters} {
