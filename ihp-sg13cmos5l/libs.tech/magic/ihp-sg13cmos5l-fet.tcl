...
proc sg13cmos5l::sg13_lv_nmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_lv_nmos $parameters
}

proc sg13cmos5l::sg13_lv_pmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_lv_pmos $parameters
}

proc sg13cmos5l::sg13_hv_nmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_hv_nmos $parameters
}

proc sg13cmos5l::sg13_hv_pmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_hv_pmos $parameters
}

proc sg13cmos5l::sg13_lv_rfnmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_lv_rfnmos $parameters
}

proc sg13cmos5l::sg13_lv_rfpmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_lv_rfpmos $parameters
}

proc sg13cmos5l::sg13_hv_rfnmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_hv_rfnmos $parameters
}

proc sg13cmos5l::sg13_hv_rfpmos_dialog {parameters} {
    sg13cmos5l::mos_dialog sg13_hv_rfpmos $parameters
}
...
proc sg13cmos5l::mos_device {parameters} {
	...
	set cext [sg13cmos5l::unionbox $cext [eval $drain_proc {$parameters}]]
    } else {
	...
	if {$viatype != 0} {
	    ...
	    sg13cmos5l::via1_draw horz $via_layers
	    popbox
	}
	set cext [sg13cmos5l::unionbox $cext [sg13cmos5l::draw_contact ${sdcontact_size} \
    ...
    if {$topc && $oldtopc} {
	   ...
	   if {$conn_gates == 0} {
	       sg13cmos5l::via1_draw horz 2 0.09
	   } else {
	       sg13cmos5l::via1_draw horz 2
	   }
           popbox
	   pushbox
    ...
    popbox
    set cext [sg13cmos5l::unionbox $cext $polybox]
    return $cext
}
...
proc sg13cmos5l::mos_draw {parameters} {
    ...
    tech lock *
    set bbox [sg13cmos5l::mos_device $parameters]
	...
	sg13cmos5l::metal_ring $gx $gy $parameters
    } else {
	set extra_gx 0
    }
	...
	if {$intc == 1} {
		...
		if {$nf == 1} {
            ...
            sg13cmos5l::mos_device $parameters
...
proc sg13cmos5l::sg13_lv_nmos_draw {parameters} {
...
proc sg13cmos5l::sg13_lv_pmos_draw {parameters} {
    set newdict [dict create \
	    gate_type		pfet \
	    diff_type 		pdiff \
...
proc sg13cmos5l::sg13_hv_pmos_draw {parameters} {
    set newdict [dict create \
	    gate_type		hvpfet \
	    diff_type 		hvpdiff \
...
proc sg13cmos5l::sg13_hv_nmos_draw {parameters} {
    set newdict [dict create \
	    gate_type		hvnfet \
	    diff_type 		hvndiff \
...
proc sg13cmos5l::sg13_lv_rfnmos_draw {parameters} {
    set newdict [dict create \
	    is_rf		1 \
	    gate_type		nfet \
	    diff_type 		ndiff \
...
proc sg13cmos5l::sg13_lv_rfpmos_draw {parameters} {
    set newdict [dict create \
	    is_rf		1 \
	    gate_type		pfet \
	    diff_type 		pdiff \
...
proc sg13cmos5l::sg13_hv_rfnmos_draw {parameters} {
    set newdict [dict create \
	    is_rf		1 \
	    gate_type		hvnfet \
	    diff_type 		hvndiff \
...
proc sg13cmos5l::sg13_hv_rfpmos_draw {parameters} {
    set newdict [dict create \
	    is_rf		1 \
	    gate_type		hvpfet \
	    diff_type 		hvpdiff \
...
proc sg13cmos5l::mos_check {device parameters} {
...
proc sg13cmos5l::sg13_lv_nmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_lv_nmos $parameters]
}

proc sg13cmos5l::sg13_hv_nmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_hv_nmos $parameters]
}

proc sg13cmos5l::sg13_lv_pmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_lv_pmos $parameters]
}

proc sg13cmos5l::sg13_hv_pmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_hv_pmos $parameters]
}

proc sg13cmos5l::sg13_lv_rfnmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_lv_rfnmos $parameters]
}

proc sg13cmos5l::sg13_hv_rfnmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_hv_rfnmos $parameters]
}

proc sg13cmos5l::sg13_lv_rfpmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_lv_rfpmos $parameters]
}

proc sg13cmos5l::sg13_hv_rfpmos_check {parameters} {
   return [sg13cmos5l::mos_check sg13_hv_rfpmos $parameters]
}
