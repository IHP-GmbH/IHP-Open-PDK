...
# Fixed-layout devices (from sg13cmos5l_fd_pr library)
#
# diodevdd_2kv
# diodevdd_4kv
# diodevss_2kv
...
proc sg13cmos5l::diodevdd_2kv_defaults {} {
...
proc sg13cmos5l::diodevdd_4kv_defaults {} {
    return {nx 1 ny 1 deltax 0 deltay 0 nocell 1 \
    compatible {diodevdd_2kv diodevdd_4kv diodevss_2kv diodevss_4kv} \
    xstep 18.1 ystep 35.67 class diode}
}

proc sg13cmos5l::diodevss_2kv_defaults {} {
    return {nx 1 ny 1 deltax 0 deltay 0 nocell 1 \
    compatible {diodevdd_2kv diodevdd_4kv diodevss_2kv diodevss_4kv} \
    xstep 13.3 ystep 35.67 class diode}
}

proc sg13cmos5l::diodevss_4kv_defaults {} {
    return {nx 1 ny 1 deltax 0 deltay 0 nocell 1 \
    compatible {diodevdd_2kv diodevdd_4kv diodevss_2kv diodevss_4kv} \
    xstep 18.1 ystep 35.67 class diode}
}

proc sg13cmos5l::nmoscl_2_defaults {} {
    return {nx 1 ny 1 deltax 0 deltay 0 nocell 1 \
    compatible {nmoscl_2 nmoscl_4} \
    xstep 35.76 ystep 24 class mosfet}
}

proc sg13cmos5l::nmoscl_4_defaults {} {
    return {nx 1 ny 1 deltax 0 deltay 0 nocell 1 \
    compatible {nmoscl_2 nmoscl_4} \
...
proc sg13cmos5l::fixed_convert {parameters} {
...
proc sg13cmos5l::diodevdd_2kv_convert {parameters} {
    return [sg13cmos5l::fixed_convert $parameters]
}

proc sg13cmos5l::diodevdd_4kv_convert {parameters} {
    return [sg13cmos5l::fixed_convert $parameters]
}

proc sg13cmos5l::diodevss_2kv_convert {parameters} {
    return [sg13cmos5l::fixed_convert $parameters]
}

proc sg13cmos5l::diodevss_4kv_convert {parameters} {
    return [sg13cmos5l::fixed_convert $parameters]
}

proc sg13cmos5l::nmoscl_2_convert {parameters} {
    return [sg13cmos5l::fixed_convert $parameters]
}

proc sg13cmos5l::nmoscl_4_convert {parameters} {
    return [sg13cmos5l::fixed_convert $parameters]
}
...
proc sg13cmos5l::fixed_dialog {device parameters} {
...
proc sg13cmos5l::diodevdd_2kv_dialog {parameters} {
    sg13cmos5l::fixed_dialog diodevdd_2kv $parameters
}

proc sg13cmos5l::diodevdd_4kv_dialog {parameters} {
    sg13cmos5l::fixed_dialog diodevdd_4kv $parameters
}

proc sg13cmos5l::diodevss_2kv_dialog {parameters} {
    sg13cmos5l::fixed_dialog diodevss_2kv $parameters
}

proc sg13cmos5l::diodevss_4kv_dialog {parameters} {
    sg13cmos5l::fixed_dialog diodevss_4kv $parameters
}

proc sg13cmos5l::nmoscl_2_dialog {parameters} {
    sg13cmos5l::fixed_dialog nmoscl_2 $parameters
}

proc sg13cmos5l::nmoscl_4_dialog {parameters} {
    sg13cmos5l::fixed_dialog nmoscl_4 $parameters
}
...
proc sg13cmos5l::fixed_draw {devname parameters} {
    ...
    # Instantiate the cell.  The name corresponds to the cell in the sg13cmos5l_fd_pr_* directory.
...
proc sg13cmos5l::fixed_check {parameters} {
...
proc sg13cmos5l::diodevdd_2kv_check {parameters} {
    return [sg13cmos5l::fixed_check $parameters]
}

proc sg13cmos5l::diodevdd_4kv_check {parameters} {
    return [sg13cmos5l::fixed_check $parameters]
}

proc sg13cmos5l::diodevss_2kv_check {parameters} {
    return [sg13cmos5l::fixed_check $parameters]
}

proc sg13cmos5l::diodevss_4kv_check {parameters} {
    return [sg13cmos5l::fixed_check $parameters]
}

proc sg13cmos5l::nmoscl_2_check {parameters} {
    return [sg13cmos5l::fixed_check $parameters]
}

proc sg13cmos5l::nmoscl_4_check {parameters} {
    return [sg13cmos5l::fixed_check $parameters]
}
