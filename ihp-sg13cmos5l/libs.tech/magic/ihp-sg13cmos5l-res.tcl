...
proc sg13cmos5l::res_recalc {field parameters} {
    set snake 0
    set sterm 0.0
    set caplen 0
...
proc sg13cmos5l::res_convert {parameters} {
...
proc sg13cmos5l::rsil_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rppd_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rhigh_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rm1_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rm2_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rm3_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rm4_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}

proc sg13cmos5l::rm5_convert {parameters} {
    return [sg13cmos5l::res_convert $parameters]
}
...
proc sg13cmos5l::res_dialog {device parameters} {
    ...
    if {[dict exists $parameters snake]} {
       magic::add_dependency sg13cmos5l::res_recalc $device sg13cmos5l l w val nx snake
    } else {
       magic::add_dependency sg13cmos5l::res_recalc $device sg13cmos5l l w val nx
    }
...
proc sg13cmos5l::rsil_dialog {parameters} {
    sg13cmos5l::res_dialog rsil $parameters
}

proc sg13cmos5l::rppd_dialog {parameters} {
    sg13cmos5l::res_dialog rppd $parameters
}

proc sg13cmos5l::rhigh_dialog {parameters} {
    sg13cmos5l::res_dialog rhigh $parameters
}

proc sg13cmos5l::rm1_dialog {parameters} {
    sg13cmos5l::res_dialog rm1 $parameters
}

proc sg13cmos5l::rm2_dialog {parameters} {
    sg13cmos5l::res_dialog rm2 $parameters
}

proc sg13cmos5l::rm3_dialog {parameters} {
    sg13cmos5l::res_dialog rm3 $parameters
}

proc sg13cmos5l::rm4_dialog {parameters} {
    sg13cmos5l::res_dialog rm4 $parameters
}

proc sg13cmos5l::rm5_dialog {parameters} {
    sg13cmos5l::res_dialog rm5 $parameters
}
...
proc sg13cmos5l::res_device {parameters} {
    ...
    box grow w ${hepl}um
    paint ${end_type}
    set cext [sg13cmos5l::unionbox $cext [sg13cmos5l::getbox]]
    popbox
	...
	if {$vias != 0} {
	    ...
	    box grow e [/ $cw 2.0]um
            sg13cmos5l::via1_draw
            popbox
    	}
	set cext [sg13cmos5l::unionbox $cext [sg13cmos5l::draw_contact ${cpl} 0 \
...
proc sg13cmos5l::res_snake_device {nf parameters} {
	...
	set cext [sg13cmos5l::draw_contact ${cpl} 0 \
		${end_surround} ${metal_surround} \
		${end_contact_size} ${end_type} ${end_contact_type} m1 horz]
    }
    popbox
...
proc sg13cmos5l::res_draw {parameters} {
    ...
    if {$snake == 1} {
	set bbox [sg13cmos5l::res_snake_device $nf $parameters]
	set nx 1
    } else {
	set bbox [sg13cmos5l::res_device $parameters]
    }
    ...
    # puts "Device position at = [sg13cmos5l::getbox]"
	...
	for {set yp 0} {$yp < $m} {incr yp} {
	    ...
	    if {$snake == 1} {
		sg13cmos5l::res_snake_device $nf $parameters
	    } else {
		sg13cmos5l::res_device $parameters
	    }
            box move n ${dy}um
        }
	popbox
...
proc sg13cmos5l::rsil_draw {parameters} {
    ...
    return [sg13cmos5l::res_draw $drawdict]
}

#----------------------------------------------------------------

proc sg13cmos5l::rppd_draw {parameters} {
...
proc sg13cmos5l::rhigh_draw {parameters} {
...
proc sg13cmos5l::rm1_draw {parameters} {
...
proc sg13cmos5l::rm2_draw {parameters} {
...
proc sg13cmos5l::rm3_draw {parameters} {
...
proc sg13cmos5l::rm4_draw {parameters} {
...
proc sg13cmos5l::rm5_draw {parameters} {
...
proc sg13cmos5l::compute_ltot {parameters} {
...
proc sg13cmos5l::res_check {device parameters} {
...
proc sg13cmos5l::rsil_check {parameters} {
    return [sg13cmos5l::res_check rsil $parameters]
}

proc sg13cmos5l::rppd_check {parameters} {
    return [sg13cmos5l::res_check rppd $parameters]
}

proc sg13cmos5l::rhigh_check {parameters} {
    return [sg13cmos5l::res_check rhigh $parameters]
}

proc sg13cmos5l::rm1_check {parameters} {
    return [sg13cmos5l::res_check rm1 $parameters]
}

proc sg13cmos5l::rm2_check {parameters} {
    return [sg13cmos5l::res_check rm2 $parameters]
}

proc sg13cmos5l::rm3_check {parameters} {
    return [sg13cmos5l::res_check rm3 $parameters]
}

proc sg13cmos5l::rm4_check {parameters} {
    return [sg13cmos5l::res_check rm4 $parameters]
}

proc sg13cmos5l::rm5_check {parameters} {
    return [sg13cmos5l::res_check rm5 $parameters]
}
