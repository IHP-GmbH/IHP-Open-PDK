...
# initial layout using the IHP sg13cmos5lA gencells.
#----------------------------------------------------------------

proc sg13cmos5l::importspice {} {
   global CAD_ROOT
   ...
   if {$Layoutfilename != ""} {
      magic::netlist_to_layout $Layoutfilename sg13cmos5l
   }
}
...
proc sg13cmos5l::create_polygon {npoints width height} {
...
proc sg13cmos5l::create_wire {npoints width height} {
...
proc sg13cmos5l::minareabox {minarea dir} {
    set curbox [box values]
    set oscale [cif scale out]
...
proc sg13cmos5l::unionbox {box1 box2} {
    set newbox []
...
proc sg13cmos5l::draw_contact {w h s o x atype ctype mtype {orient vert}} {
...
proc sg13cmos5l::metal_ring {gw gh parameters} {
...
proc sg13cmos5l::guard_ring {gw gh parameters} {
    ...
    if {$tbcov > 0.0} {
        if {$gtc == 1} {
            pushbox
            box move n ${hh}um
            sg13cmos5l::draw_contact $cw 0 $diff_surround $metal_surround \
    ...
    if {$rlcov > 0.0} {
        if {$grc == 1} {
            pushbox
            box move e ${hw}um
            sg13cmos5l::draw_contact 0 $ch $diff_surround $metal_surround \
		$plus_contact_size $plus_diff_type \
