...
proc sg13cmos5l::SVaricap_defaults {} {
...
proc sg13cmos5l::var_convert {parameters} {
...
proc sg13cmos5l::SVaricap_convert {parameters} {
...
proc sg13cmos5l::var_dialog {device parameters} {
...
proc sg13cmos5l::SVaricap_dialog {parameters} {
    sg13cmos5l::var_dialog SVaricap $parameters
}
...
proc sg13cmos5l::var_device {parameters} {
    ...
    popbox
    if {$doports && ($term_cmos5l != "")} {
        label $term_cmos5l c m1
	select area label
	port make
    }
    popbox
...
proc sg13cmos5l::var_draw {parameters} {
    tech unlock *
    set curunits [units]
    units internal
    ...
    tech lock *
    set bbox [sg13cmos5l::var_device $parameters]
    tech unlock *
	...
	if {$xp == [/ $nx 2]} {
	    ...
	    dict set parameters term_cmos5l G2 
	} else {
	    dict set parameters add_sub 0
	    dict set parameters term_g1 ""
	    dict set parameters term_cmos5l ""
	}
	pushbox
	sg13cmos5l::var_device $parameters
	popbox
        box move e ${dx}um
    }
    popbox
...
proc sg13cmos5l::SVaricap_draw {parameters} {
    set newdict [dict create \
	    metal_surround	0.32 \
    ]
    set drawdict [dict merge $sg13cmos5l::ruleset $newdict $parameters]
    return [sg13cmos5l::var_draw $drawdict]
}
...
proc sg13cmos5l::var_check {parameters} {
...
proc sg13cmos5l::SVaricap_check {parameters} {
    return [sg13cmos5l::var_check $parameters]
}
