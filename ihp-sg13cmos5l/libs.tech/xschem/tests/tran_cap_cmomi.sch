...
save all
tran 1n 2u
write tran_cap_cmomi.raw
.endc
" }
C {devices/title.sym} 160 -30 0 0 {name=l1 author="Copyright 2026 IHP PDK Authors"}
C {devices/vsource.sym} 340 -290 0 0 {name=V1 value="pwl 0 0 1u 0 1.001u 1"}
...
descr="load waves"
tclcommand="xschem raw_read $netlist_dir/tran_cap_cmomi.raw tran"
}
C {sg13cmos5l_pr/cap_cmomi.sym} 530 -380 1 0 {name=C1 model=cap_cmomi w=10.0e-6 l=70.0e-6 mmin=1 mmax=4 feed=double subblock=0 m=1 mm_ok=1 spiceprefix=X}
