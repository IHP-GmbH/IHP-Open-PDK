...
//		
//		Generated on Mon Jun 29 15:00:10 2026		
//
// ------------------------------------------------------ 
`timescale 1ns/10ps
`celldefine
module RM_IHPSG13_2P_64x22_c2_bm_bist (
    A_CLK,
    A_MEN,
    A_WEN,
    A_REN,
    ...
    input [21:0] A_BIST_DIN;
    input [21:0] A_BIST_BM;
    input B_CLK;
    input B_MEN;
    input B_WEN;
    input B_REN;
    ...
    input B_BIST_WEN;
    input B_BIST_REN;
    input [5:0] B_BIST_ADDR;
    input [21:0] B_BIST_DIN;
    input [21:0] B_BIST_BM;
...
`else
    ...
    wire [21:0] A_BM_DELAY;
    wire A_BIST_CLK_DELAY;
    wire A_BIST_MEN_DELAY;
    wire A_BIST_WEN_DELAY;
    wire A_BIST_REN_DELAY;
    wire [5:0] A_BIST_ADDR_DELAY;
    wire [21:0] A_BIST_DIN_DELAY;
    wire [21:0] A_BIST_BM_DELAY;
    wire B_CLK_DELAY;
    wire B_MEN_DELAY;
    wire B_WEN_DELAY;
    wire B_REN_DELAY;
    ...
    wire [21:0] B_BM_DELAY;
    wire B_BIST_CLK_DELAY;
    wire B_BIST_MEN_DELAY;
    wire B_BIST_WEN_DELAY;
    wire B_BIST_REN_DELAY;
    wire [5:0] B_BIST_ADDR_DELAY;
    wire [21:0] B_BIST_DIN_DELAY;
    wire [21:0] B_BIST_BM_DELAY;
