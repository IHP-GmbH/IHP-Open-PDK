...
C {sg13_lv_pmos.sym} -200 -830 0 0 {name=M4 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 10 -840 0 0 {name=M5 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 200 -810 0 0 {name=M6 w=2.24u l=130.00n ng=2 m=1 model=sg13_lv_pmos}
