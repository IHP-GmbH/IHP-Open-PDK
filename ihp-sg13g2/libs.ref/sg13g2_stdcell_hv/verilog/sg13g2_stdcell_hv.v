...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_a21o_1
//   cell_description : 2-input AND into first input of 2-input OR.
//*****************************************************************

module sg13g2_hv_a21o_1 (X, A1, A2, B1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_a21o_2
//   cell_description : 2-input AND into first input of 2-input OR.
//*****************************************************************

module sg13g2_hv_a21o_2 (X, A1, A2, B1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_a21oi_1
//   cell_description : 2-input AND into first input of 2-input NOR.
//*****************************************************************

module sg13g2_hv_a21oi_1 (Y, A1, A2, B1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_a21oi_2
//   cell_description : 2-input AND into first input of 2-input NOR.
//*****************************************************************

module sg13g2_hv_a21oi_2 (Y, A1, A2, B1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_a221oi_1
//   cell_description : 2-input AND into first two inputs of 3-input NOR.
//*****************************************************************

module sg13g2_hv_a221oi_1 (Y, A1, A2, B1, B2, C1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_a22oi_1
//   cell_description : 2-input AND into both inputs of 2-input NOR.
//*****************************************************************

module sg13g2_hv_a22oi_1 (Y, A1, A2, B1, B2);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_and2_1
//   cell_description : 2-input AND
//*****************************************************************

module sg13g2_hv_and2_1 (X, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_and2_2
//   cell_description : 2-input AND
//*****************************************************************

module sg13g2_hv_and2_2 (X, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_and3_1
//   cell_description : 3-input AND
//*****************************************************************

module sg13g2_hv_and3_1 (X, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_sighold
//   cell_description : 3-input AND
//*****************************************************************

module sg13g2_hv_and3_2 (X, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_and4_1
//   cell_description : 4-input AND
//*****************************************************************

module sg13g2_hv_and4_1 (X, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_and4_2
//   cell_description : 4-input AND
//*****************************************************************

module sg13g2_hv_and4_2 (X, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_buf_1
//   cell_description : Buffer drive strength 1
//*****************************************************************

module sg13g2_hv_buf_1 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_buf_16
//   cell_description : Buffer drive strength 16
//*****************************************************************

module sg13g2_hv_buf_16 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_buf_2
//   cell_description : Buffer drive strength 2
//*****************************************************************

module sg13g2_hv_buf_2 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_buf_4
//   cell_description : Buffer drive strength 4
//*****************************************************************

module sg13g2_hv_buf_4 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_buf_8
//   cell_description : Buffer drive strength 8
//*****************************************************************

module sg13g2_hv_buf_8 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_decap_4
//   cell_description : Decoupling capasitance filler cell
//*****************************************************************

module sg13g2_hv_decap_4 ();
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_decap_8
//   cell_description : Decoupling capasitance filler cell
//*****************************************************************

module sg13g2_hv_decap_8 ();
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_dfrbp_2
//   cell_description : Posedge Two-Outputs Q and Q_N D-Flip-Flop with Low-Active Reset
//*****************************************************************

module sg13g2_hv_dfrbp_2 (Q, Q_N, CLK, D, RESET_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_dfrbpq_2
//   cell_description : Posedge Single-Output Q D-Flip-Flop with Low-Active Reset
//*****************************************************************

module sg13g2_hv_dfrbpq_2 (Q, CLK, D, RESET_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_dlhq_1
//   cell_description : High-Active GATE Single-Output Q D-latch
//*****************************************************************

module sg13g2_hv_dlhq_1 (Q, D, GATE);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_dlygate4sd1_1
//   cell_description : Delay Cell, typical 0.4 ns
//*****************************************************************

module sg13g2_hv_dlygate4sd1_1 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_dlygate4sd2_1
//   cell_description : Delay Cell, typical 0.45 ns
//*****************************************************************

module sg13g2_hv_dlygate4sd2_1 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_dlygate4sd3_1
//   cell_description : Delay Cell, typical 0.7 ns
//*****************************************************************

module sg13g2_hv_dlygate4sd3_1 (X, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_ebufn_2
//   cell_description : Tristate Buffer with Low-Active Enable TE_B
//*****************************************************************

module sg13g2_hv_ebufn_2 (Z, A, TE_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_ebufn_4
//   cell_description : Tristate Buffer with Low-Active Enable TE_B
//*****************************************************************

module sg13g2_hv_ebufn_4 (Z, A, TE_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_ebufn_8
//   cell_description : Tristate Buffer with Low-Active Enable TE_B
//*****************************************************************

module sg13g2_hv_ebufn_8 (Z, A, TE_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_einvn_2
//   cell_description : Tristate Inverter with Low-Active Enable TE_B
//*****************************************************************

module sg13g2_hv_einvn_2 (Z, A, TE_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_einvn_4
//   cell_description : Tristate Inverter with Low-Active Enable TE_B
//*****************************************************************

module sg13g2_hv_einvn_4 (Z, A, TE_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_einvn_8
//   cell_description : Tristate Inverter with Low-Active Enable TE_B
//*****************************************************************

module sg13g2_hv_einvn_8 (Z, A, TE_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_fill_1
//   cell_description : Filler 1 Track Width
//*****************************************************************

module sg13g2_hv_fill_1 ();
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_fill_2
//   cell_description : Filler 2 Tracks Width
//*****************************************************************

module sg13g2_hv_fill_2 ();
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_fill_4
//   cell_description : Filler 4 Tracks Width
//*****************************************************************

module sg13g2_hv_fill_4 ();
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_fill_8
//   cell_description : Filler 8 Tracks Width
//*****************************************************************

module sg13g2_hv_fill_8 ();
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_inv_1
//   cell_description : Inverter
//*****************************************************************

module sg13g2_hv_inv_1 (Y, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_inv_16
//   cell_description : Inverter
//*****************************************************************

module sg13g2_hv_inv_16 (Y, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_inv_2
//   cell_description : Inverter
//*****************************************************************

module sg13g2_hv_inv_2 (Y, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_inv_4
//   cell_description : Inverter
//*****************************************************************

module sg13g2_hv_inv_4 (Y, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_inv_8
//   cell_description : Inverter
//*****************************************************************

module sg13g2_hv_inv_8 (Y, A);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_lgcp_1
//   cell_description : Posedge Clock Gating cell, Low Latch Enable
//*****************************************************************

module sg13g2_hv_lgcp_1 (GCLK, CLK, GATE);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_mux2_1
//   cell_description : Multiplexer from 2 to 1
//*****************************************************************

module sg13g2_hv_mux2_1 (X, A0, A1, S);
...
// Verilog for cell sg13g2_hv_mux2_2 created entirely by Liberate 23.1.3.126.isr3
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_mux2_2
//   cell_description : Multiplexer from 2 to 1
//*****************************************************************

module sg13g2_hv_mux2_2 (X, A0, A1, S);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_mux4_1
//   cell_description : Multiplexer from 4 to 1
//*****************************************************************

module sg13g2_hv_mux4_1 (X, A0, A1, A2, A3, S0, S1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand2_1
//   cell_description : 2-input NAND
//*****************************************************************

module sg13g2_hv_nand2_1 (Y, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand2_2
//   cell_description : 2-input NAND
//*****************************************************************

module sg13g2_hv_nand2_2 (Y, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand2b_1
//   cell_description : 2-input NAND with Inverted Input A_N
//*****************************************************************

module sg13g2_hv_nand2b_1 (Y, A_N, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand2b_2
//   cell_description : 2-input NAND with Inverted Input A_N
//*****************************************************************

module sg13g2_hv_nand2b_2 (Y, A_N, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand3_1
//   cell_description : 3-input NAND
//*****************************************************************

module sg13g2_hv_nand3_1 (Y, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand3b_1
//   cell_description : 3-input NAND3 with Inverted Input A_N
//*****************************************************************

module sg13g2_hv_nand3b_1 (Y, A_N, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nand4_1
//   cell_description : 4-input NAND
//*****************************************************************

module sg13g2_hv_nand4_1 (Y, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor2_1
//   cell_description : 2-input NOR
//*****************************************************************

module sg13g2_hv_nor2_1 (Y, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor2_2
//   cell_description : 2-input NOR
//*****************************************************************

module sg13g2_hv_nor2_2 (Y, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor2b_1
//   cell_description : 2-input NOR2 with Inverted Input B_N
//*****************************************************************

module sg13g2_hv_nor2b_1 (Y, A, B_N);
...
module sg13g2_hv_nor2b_2 (Y, A, B_N);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor3_1
//   cell_description : 3-input NOR
//*****************************************************************

module sg13g2_hv_nor3_1 (Y, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor3_2
//   cell_description : 3-input NOR
//*****************************************************************

module sg13g2_hv_nor3_2 (Y, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor4_1
//   cell_description : 4-input NOR
//*****************************************************************

module sg13g2_hv_nor4_1 (Y, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_nor4_2
//   cell_description : 4-input NOR
//*****************************************************************

module sg13g2_hv_nor4_2 (Y, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_o21ai_1
//   cell_description : 2-input OR into 2-input NAND
//*****************************************************************

module sg13g2_hv_o21ai_1 (Y, A1, A2, B1);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_or2_1
//   cell_description : 2-input OR
//*****************************************************************

module sg13g2_hv_or2_1 (X, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_or2_2
//   cell_description : 2-input OR
//*****************************************************************

module sg13g2_hv_or2_2 (X, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_or3_1
//   cell_description : 3-input OR
//*****************************************************************

module sg13g2_hv_or3_1 (X, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_or3_2
//   cell_description : 3-input OR
//*****************************************************************

module sg13g2_hv_or3_2 (X, A, B, C);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_or4_1
//   cell_description : 4-input OR
//*****************************************************************

module sg13g2_hv_or4_1 (X, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_or4_2
//   cell_description : 4-input OR
//*****************************************************************

module sg13g2_hv_or4_2 (X, A, B, C, D);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_sdfbbp_1
//   cell_description : Posedge Two-Outputs D-Flip-Flop with Reset, Set and Scan
//*****************************************************************

module sg13g2_hv_sdfbbp_1 (Q, Q_N, CLK, D, RESET_B, SCD, SCE, SET_B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_sdfrbp_1
//   cell_description : Posedge Two-Outputs Q and Q_N D-Flip-Flop with Reset and Scan
//*****************************************************************

module sg13g2_hv_sdfrbp_1 (Q, Q_N, CLK, D, RESET_B, SCD, SCE);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_sdfrbp_2
//   cell_description : Posedge Two-Outputs Q and Q_N D-Flip-Flop with Reset and Scan
//*****************************************************************

module sg13g2_hv_sdfrbp_2 (Q, Q_N, CLK, D, RESET_B, SCD, SCE);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_sdfrbpq_1
//   cell_description : Posedge Single-Output Q D-Flip-Flop with Reset and Scan
//*****************************************************************

module sg13g2_hv_sdfrbpq_1 (Q, CLK, D, RESET_B, SCD, SCE);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_sdfrbpq_2
//   cell_description : Posedge Single-Output Q D-Flip-Flop with Reset and Scan
//*****************************************************************

module sg13g2_hv_sdfrbpq_2 (Q, CLK, D, RESET_B, SCD, SCE);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_slgcp_1
//   cell_description : Scan gated clock
//*****************************************************************

module sg13g2_hv_slgcp_1 (GCLK, GATE, CLK, SCE);
  ...
  `ifdef DISPLAY_HOLD 
     ...
     begin
      #0 $display("  > Warning: compiler directive DISPLAY_HOLD is set in cell"
         ...
         $display("  > %m");
         $display("  > sg13g2_hv_sighold cell model is switched to provide logic levels"
                  );
...
//   sg13g2_hv_sighold cell 
// - sg13g2_hv_sighold cell compensates leackage current only in case of
//   undriven node/bus and system stop
// - sg13g2_hv_sighold cell holds the bus bit on "0" or "1", but does not 
...
// compensator cell sg13g2_hv_sighold*
//
     buf (n1, SH);
     bufif1 (SH, n1, 1'b0); /* always inactive */
  `endif
 
// no timing modelled for sg13g2_hv_sighold cell
// no backannotation possible for sg13g2_hv_sighold cell 
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_xnor2_1
//   cell_description : 2-input XNOR
//*****************************************************************

module sg13g2_hv_xnor2_1 (Y, A, B);
...
//*****************************************************************
//   technology       : SG13G2
//   module name      : sg13g2_hv_xor2_1
//   cell_description : 2-input XOR
//*****************************************************************

module sg13g2_hv_xor2_1 (X, A, B);
