...
### Extracted Polygons ###
        ...
        if self.model == 'diodevdd_4kv':
            ...
            dbCreateRectArray(self, via1_layer, origin=(2.005, 21.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(2.005, 30.72), n=6, m=3, x1=0.19, off1=via1_sep)
            
            dbCreateRectArray(self, via1_layer, origin=(6.565,  3.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(6.565, 12.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(6.565, 21.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(6.565, 30.72), n=6, m=3, x1=0.19, off1=via1_sep)
            
            dbCreateRectArray(self, via1_layer, origin=(11.125,  3.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(11.125, 12.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(11.125, 21.72), n=6, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(11.125, 30.72), n=6, m=3, x1=0.19, off1=via1_sep)
            
            dbCreateRectArray(self, via1_layer, origin=(4.305,  7.68), n=8, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(4.305, 16.68), n=8, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(4.305, 25.68), n=8, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(8.835,  7.68), n=8, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(8.835, 16.68), n=8, m=3, x1=0.19, off1=via1_sep)
            dbCreateRectArray(self, via1_layer, origin=(8.835, 25.68), n=8, m=3, x1=0.19, off1=via1_sep)
