...
pcellCmimTest = ly.create_cell("cmim_test", "SG13_dev", {})
...
#pcellRsil = ly.create_cell("rsil", "SG13_dev", { "l": "3e-6", "w": "6e-6", "b": 1, "ps": "1e-6", "R": "1e-6"})
...
top.insert(pya.DCellInstArray(pcellSealring, pya.DTrans(pya.DVector(70, -9))))
top.insert(pya.DCellInstArray(pcellNpn13G2, pya.DTrans(pya.DVector(3, 8))))
top.insert(pya.DCellInstArray(pcellNpn13G2L, pya.DTrans(pya.DVector(8, 5))))
top.insert(pya.DCellInstArray(pcellNpn13G2V, pya.DTrans(pya.DVector(20, 5))))
top.insert(pya.DCellInstArray(pcellRsil, pya.DTrans(pya.DVector(0, 15))))
top.insert(pya.DCellInstArray(pcellRhigh, pya.DTrans(pya.DVector(3, 15))))
top.insert(pya.DCellInstArray(pcellRppd, pya.DTrans(pya.DVector(6, 15))))
