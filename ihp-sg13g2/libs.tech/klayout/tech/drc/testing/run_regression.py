...
def run_test_case(
    ...
    # Force default DRC JSON so regression runs compare against goldens that
    # were generated with the baseline rule values (matching the maximal deck
    # hardcoded thresholds). Without this, the orchestrator picks
