...
# Rules generated by RULES_VAR expansion that don't exist in the DRC deck.
# The parser expands #{met_abbrev} and #{via_name} to all values, but Ruby
# conditionals (if/case/when) restrict which metals/vias get which rules.
# Confirmed against SG13G2_os_layout_rules.pdf sections 6.10 and 7.3.
RULES_EXCLUDE = {
    # Slt.g only exists for M5 and TM1 (sec 7.3: slit space to MIM)
    "Slt.g.M1", "Slt.g.M2", "Slt.g.M3", "Slt.g.M4", "Slt.g.TM2",
    # Slt.h2 only for M2-M5; M1=Slt.h1, TM1=Slt.h3, TM2=Slt.h4
    "Slt.h2.M1", "Slt.h2.TM1", "Slt.h2.TM2",
    # Seal.c1 iterates Via1-Via4 only; TopVia1=Seal.c2, TopVia2=Seal.c3
    "Seal.c1.TopVia1", "Seal.c1.TopVia2",
}
...
def parse_existing_rules(
    ...
    # Drop phantom rules from RULES_VAR over-expansion (guarded by Ruby conditionals)
    df.drop(df[df["rule_name"].isin(RULES_EXCLUDE)].index, inplace=True)
