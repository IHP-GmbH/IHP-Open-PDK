...
|  | `cap_mom` | `C1 PLUS MINUS cap_mom w=7u l=7u`<br>`or`<br>`C1 PLUS MINUS 48.8f cap_mom w=7u l=7u` | topological (`w`, `l` non-primary) | [`C4`](#note-c4) | [CDL](./testcases/unit/cap_devices/netlist/cap_mom.cdl) / [GDS](./testcases/unit/cap_devices/layout/cap_mom.gds) |
