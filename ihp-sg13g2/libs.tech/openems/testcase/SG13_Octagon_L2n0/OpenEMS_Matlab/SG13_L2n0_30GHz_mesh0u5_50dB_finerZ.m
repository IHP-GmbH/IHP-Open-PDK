...
mesh.z = [Sub.zmin linspace(Sub.zmax/2,Sub.zmax,20) ];
% mesh.z = [Sub.zmin Sub.zmax];
...
mesh.z = [mesh.z linspace(EPI.zmin,EPI.zmax,5)];
...
mesh.z = [mesh.z linspace(TopMetal2.zmin,TopMetal2.zmax,7)];
...
mesh.z = [mesh.z linspace(TopMetal1.zmin,TopMetal1.zmax,6)];
...
mesh.z = [mesh.z linspace(TopVia2.zmin,TopVia2.zmax,3)];

%% add some mesh lines below TopMetal1 down to EPI, approx 1um spacing
mesh.z = [mesh.z linspace(EPI.zmax,TopMetal1.zmin,7)];
...
mesh.z = SmoothMeshLines( mesh.z, max_cellsize, 1.5, 0);
