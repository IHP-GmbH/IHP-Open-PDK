...
<Properties>
  ...
  <RunScript=0>
  <showFrame=3>
  <FrameText0=AC MoM capacitor (cap_cmomi) -3dB extraction>
...
<Components>
  ...
  <cmomi C1 1 220 210 -27 23 0 0 "cap_cmomi" 0 "X" 0 "10.0" 1 "70.0" 1 "1" 0 "5" 0 "double" 1 "0" 0 "1" 0 "m*(((mmax-mmin+1<=2)?0.55:((mmax-mmin+1==3)?0.82:((mmax-mmin+1==4)?1.09:1.36)))*(max(1,rint(l*1e6/0.84+1e-6-0.5))*0.84)*(max(2,rint(w*1e6/0.89+1e-6-0.5))*0.89)+0.152*(max(2,rint(w*1e6/0.89+1e-6-0.5))*0.89+0.42))*1e-15" 1 "1" 0>
</Components>
<Wires>
