...
C {devices/iopin.sym} -180 -1520 2 0 {name=p5 lab=VDD}
C {devices/iopin.sym} -190 -890 2 0 {name=p6 lab=VSS}
C {sg13_lv_nmos.sym} 410 -1170 0 0 {name=M1 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 410 -1070 0 0 {name=M2 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 410 -970 0 0 {name=M3 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 620 -990 0 0 {name=M4 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} 90 -1440 0 0 {name=M5 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 260 -1440 0 0 {name=M6 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 410 -1440 0 0 {name=M7 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 620 -1440 0 0 {name=M8 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
