...
C {devices/iopin.sym} 1260 -1800 2 0 {name=p6 lab=VDD}
C {devices/iopin.sym} 1260 -960 2 0 {name=p7 lab=VSS}
C {sg13_lv_nmos.sym} 1870 -1280 0 0 {name=M1 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1870 -1190 0 0 {name=M2 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1870 -1100 0 0 {name=M3 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1870 -1010 0 0 {name=M4 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 2030 -1120 0 0 {name=M5 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} 1500 -1680 0 0 {name=M6 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1630 -1680 0 0 {name=M7 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1750 -1680 0 0 {name=M8 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1870 -1680 0 0 {name=M9 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 2030 -1640 0 0 {name=M10 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
