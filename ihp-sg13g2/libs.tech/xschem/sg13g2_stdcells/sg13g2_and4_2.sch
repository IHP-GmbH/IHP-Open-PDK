...
C {devices/iopin.sym} 970 -1800 2 0 {name=p6 lab=VDD}
C {devices/iopin.sym} 980 -960 2 0 {name=p7 lab=VSS}
C {sg13_lv_nmos.sym} 1640 -1280 0 0 {name=M1 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1640 -1190 0 0 {name=M2 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1640 -1100 0 0 {name=M3 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1640 -1010 0 0 {name=M4 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1830 -1090 0 0 {name=M5 w=1.48u l=130.00n ng=2 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} 1220 -1680 0 0 {name=M6 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1360 -1680 0 0 {name=M7 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1500 -1680 0 0 {name=M8 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1640 -1680 0 0 {name=M9 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1830 -1680 0 0 {name=M10 w=2.24u l=130.00n ng=2 m=1 model=sg13_lv_pmos}
