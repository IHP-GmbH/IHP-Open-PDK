...
C {devices/iopin.sym} -320 -1280 2 0 {name=p5 lab=VDD}
C {devices/iopin.sym} -330 -720 2 0 {name=p6 lab=VSS}
C {sg13_lv_nmos.sym} -170 -810 0 0 {name=M1 w=550.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 50 -930 0 0 {name=M2 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 50 -810 0 0 {name=M3 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 280 -930 0 0 {name=M4 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 280 -810 0 0 {name=M5 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 510 -840 0 0 {name=M6 w=1.48u l=130.00n ng=2 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} -170 -1160 0 0 {name=M7 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 50 -1190 0 0 {name=M8 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 50 -1070 0 0 {name=M9 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 280 -1190 0 0 {name=M10 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 280 -1070 0 0 {name=M11 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 510 -1150 0 0 {name=M12 w=2.24u l=130.00n ng=2 m=1 model=sg13_lv_pmos}
