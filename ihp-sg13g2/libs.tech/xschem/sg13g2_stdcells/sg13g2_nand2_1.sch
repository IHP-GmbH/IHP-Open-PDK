...
C {sg13_lv_nmos.sym} 1130 -50 0 0 {name=M1 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1130 90 0 0 {name=M2 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} 920 -210 0 0 {name=M3 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1130 -210 0 0 {name=M4 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
