...
C {devices/iopin.sym} -360 -80 2 0 {name=p4 lab=VDD}
C {devices/iopin.sym} -360 600 2 0 {name=p5 lab=VSS}
C {sg13_lv_nmos.sym} -40 420 0 0 {name=M1 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} -40 520 0 0 {name=M2 w=640.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 120 530 0 0 {name=M3 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 260 400 0 0 {name=M4 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 260 530 0 0 {name=M5 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} -160 40 0 0 {name=M6 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} -40 40 0 0 {name=M7 w=840.00n l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 130 0 0 0 {name=M8 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 130 100 0 0 {name=M9 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 260 10 0 0 {name=M10 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
