...
C {devices/iopin.sym} 554 -1190 2 0 {name=p4 lab=VDD}
C {devices/iopin.sym} 540 -480 2 0 {name=p5 lab=VSS}
C {sg13_lv_nmos.sym} 630 -600 0 0 {name=M1 w=550.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 760 -600 0 0 {name=M2 w=550.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1120 -720 0 0 {name=M3 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1320 -720 0 0 {name=M4 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 1320 -560 0 0 {name=M5 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} 760 -1120 0 0 {name=M6 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 760 -940 0 0 {name=M7 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1120 -1120 0 0 {name=M8 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1220 -940 0 0 {name=M9 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 1320 -1120 0 0 {name=M10 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
