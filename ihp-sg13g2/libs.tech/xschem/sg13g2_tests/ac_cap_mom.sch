...
descr="load waves"
tclcommand="xschem raw_read $netlist_dir/ac_cap_mom.raw ac"
}
C {sg13g2_pr/cap_mom.sym} 530 -380 1 0 {name=C1 model=cap_mom w=10.0e-6 l=70.0e-6 mmin=1 mmax=5 feed=double spiceprefix=X}
