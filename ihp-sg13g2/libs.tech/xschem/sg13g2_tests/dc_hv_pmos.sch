...
sim_type=dc
autoload=1}
T {Ctrl-Click to execute launcher} 610 -90 0 0 0.3 0.3 {layer=11}
T {.save file can be created with IHP->"Create FET and BIP .save file"} 610 30 0 0 0.3 0.3 {layer=11}
N -110 70 -110 90 {
lab=GND}
N -110 -0 -110 10 {
lab=#net1}
...
"}
C {devices/code_shown.sym} 220 -50 0 0 {name=NGSPICE only_toplevel=true 
value="
.param temp=27
...
C {devices/launcher.sym} 670 -20 0 0 {name=h1
descr="OP annotate" 
tclcommand="xschem annotate_op"
}
C {devices/launcher.sym} 670 10 0 0 {name=h2
descr="Load waves" 
tclcommand="
...
C {launcher.sym} 670 -50 0 0 {name=h3
