...
C {sg13g2_tests_xyce/dc_lv_nmos.sym} 180 -630 0 0 {name=x5}
C {sg13g2_tests_xyce/dc_diode_op.sym} 180 -320 0 0 {name=x14}
C {sg13g2_tests_xyce/dc_diode_temp.sym} 180 -290 0 0 {name=x15}
C {sg13g2_tests_xyce/dc_res_temp.sym} 180 -440 0 0 {name=x13}
C {sg13g2_tests_xyce/dc_lv_pmos.sym} 180 -570 0 0 {name=x7}
C {sg13g2_tests_xyce/dc_logic_not.sym} 180 -190 0 0 {name=x28}
C {sg13g2_tests_xyce/tran_logic_not.sym} 520 -590 0 0 {name=x27}
C {sg13g2_tests_xyce/dc_hbt_13g2.sym} 180 -260 0 0 {name=x17}
C {sg13g2_tests_xyce/tran_logic_nand.sym} 520 -550 0 0 {name=x29}
C {sg13g2_tests_xyce/ac_lv_nmosrf.sym} 860 -630 0 0 {name=x9}
C {sg13g2_tests_xyce/mc_res_op.sym} 1200 -440 0 0 {name=x16}
C {sg13g2_tests_xyce/ac_mim_cap.sym} 860 -590 0 0 {name=x21}
C {sg13g2_tests_xyce/tran_mim_cap.sym} 520 -630 0 0 {name=x10}
C {sg13g2_tests_xyce/dc_hv_nmos.sym} 180 -600 0 0 {name=x6}
C {sg13g2_tests_xyce/dc_mos_temp.sym} 180 -510 0 0 {name=x11}
